...
#* This is the original model of DF
...
class DFNet:
    ...
    def build(input_shape, classes):
        model = Sequential()
        #Block1
        filter_num = ['None',32,64,128,256]         #* Maps in each block
        kernel_size = ['None',8,8,8,8]              #* Kernels: 1x8
        conv_stride_size = ['None',1,1,1,1]
        pool_stride_size = ['None',4,4,4,4]
        pool_size = ['None',8,8,8,8]                #* Pool: 1x8

        #* Block 1: Activation ELU
        ...
        #* FC layer 2
        model.add(Dense(512, kernel_initializer=glorot_uniform(seed=0), name='fc2'))        #* FC
        model.add(BatchNormalization())
        ...
        #* Output prediction
        model.add(Dense(classes, kernel_initializer=glorot_uniform(seed=0), name='fc3'))    #* FC
